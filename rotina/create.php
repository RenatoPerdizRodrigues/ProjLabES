    ...
    <div class="card">
        ...
        <div class="card-block">
            <form action="create.php?id=<?php echo $_GET['id'];?>" method="post">
                ...
                <div class="form-group">
                    <label for="exampleFormControlSelect1">Aparelho</label>
                    <select class="form-control" id="exampleFormControlSelect1" name="ap5" required>
                ...
                <div class="form-group">
                    <label for="exampleFormControlSelect1">Exercício</label>
                    <select class="form-control" id="exampleFormControlSelect1" name="ex5" required>
                ...
                <div class="form-group">
                    <label>Repetições</label>
                    <input type="number" name="rep5" class="form-control" required>
                </div>
                <br>
